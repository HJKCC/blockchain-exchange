...
public class HuobiAuthentication {
  ...
  public void createSignature(String accessKey, String secretKey, String methodType, String domainName,
      String methodPath, UrlParamsBuilder builder) {
    ...
    sb.append(methodType.toUpperCase()).append('\n')
        .append(domainName.toLowerCase()).append('\n')
        .append(methodPath).append('\n');
