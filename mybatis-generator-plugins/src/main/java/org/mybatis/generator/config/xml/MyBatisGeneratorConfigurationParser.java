...
public class MyBatisGeneratorConfigurationParser {
    ...
    protected void parseTable(Context context, Node node) {
        ...
        if (stringHasValue(enableInsert) && isTrue(enableInsert)) {
        ...
        if (stringHasValue(enableSelectByPrimaryKey) && isTrue(enableSelectByPrimaryKey)) {
        ...
        if (stringHasValue(enableSelectByExample) && isTrue(enableSelectByExample)) {
        ...
        if (stringHasValue(enableUpdateByPrimaryKey) && isTrue(enableUpdateByPrimaryKey)) {
        ...
        if (stringHasValue(enableDeleteByPrimaryKey) && isTrue(enableDeleteByPrimaryKey)) {
        ...
        if (stringHasValue(enableDeleteByExample) && isTrue(enableDeleteByExample)) {
        ...
        if (stringHasValue(enableCountByExample) && isTrue(enableCountByExample)) {
        ...
        if (stringHasValue(enableUpdateByExample) && isTrue(enableUpdateByExample)) {
        ...
        if (stringHasValue(delimitAllColumns) && isTrue(delimitAllColumns)) {
    ...
    private void parseColumnOverride(TableConfiguration tc, Node node) {
        ...
        if (stringHasValue(delimitedColumnName) && isTrue(delimitedColumnName)) {
            co.setColumnNameDelimited(true);
        }
